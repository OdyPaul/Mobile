...
import Svg, { G, Path, Polygon, Rect, Circle } from "react-native-svg";
const SVGComponent = (props) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" {...props}>
    <G id="freepik--Floor--inject-1--inject-156">
      <Path
    ...
    <G id="freepik--Shadows--inject-1--inject-156">
      <Path
    ...
    <G id="freepik--Pencil--inject-1--inject-156">
      <Path
    ...
    <G id="freepik--Backpack--inject-1--inject-156">
      <Path
    ...
    <G id="freepik--game-console--inject-1--inject-156">
      <Path
    ...
    <G id="freepik--Cloud--inject-1--inject-156">
      <Path
    ...
    <G id="freepik--Character--inject-1--inject-156">
      ...
      >
        <Path d="M317.59,335.63h2.2a10,10,0,0,1,1.06-4.8,3,3,0,0,0,1.81.59,5.69,5.69,0,0,0,2.73-.86,8.36,8.36,0,0,0,2.54-2.23,1.43,1.43,0,0,0,.14-.2,3.61,3.61,0,0,0,.65-1.88l58.07-33.52,2-1.15,2.52-1.45a1.32,1.32,0,0,0,.77-1.13v-2.57a1.35,1.35,0,0,1-.77,1.16l0,0-6.67,3.84-56.15,32.43c-1.05.6-1.9,1.36-1.9,1.7v.6a1.81,1.81,0,0,1-.52,1,6.26,6.26,0,0,1-1.72,1.44c-1.24.72-2.24.75-2.24.09v-.59c0-.35-.49-.32-1.12,0l-1.11.65C318.59,329.55,317.59,332.6,317.59,335.63Z" />
        <Path d="M319.79,335.63v16.29c0,.23,0,.46,0,.68l.05.55a.09.09,0,0,0,0,.05c.2-1.75,1.87-3.31,3.32-4.13a5.49,5.49,0,0,1,2.69-.84,3,3,0,0,1,2,.73l.19-.11.39-.23,56.15-32.43,3.23-1.86.92-.54,2.72-1.57a1.28,1.28,0,0,0,.6-1.05v2.57a1.26,1.26,0,0,1-.56,1l0,0c-.32.19-.66.37-1,.58l-.63.37-1.08.62c-.24.15-.46.28-.67.39s-.33.2-.47.27l-.83.49-44.61,25.74-14.24,8.22c-1,.6-1.83.81-1.89.5a.59.59,0,0,1,0-.11v-.57c0-.72-1-.72-2.23,0a3,3,0,0,0-1.76,2.24v.7a1,1,0,0,1-.33.84l-.33.19-.7.4-.87.51a.89.89,0,0,1-1.11-.1.27.27,0,0,1-.11-.1,1,1,0,0,1-.2-.26h0a.71.71,0,0,1-.1-.14,2.31,2.31,0,0,1-.25-.55,3.87,3.87,0,0,1-.2-.63c-.06-.25-.1-.49-.14-.75a2.22,2.22,0,0,1-.06-.45c0-.12,0-.23,0-.37s0-.56,0-.85V335.63Z" />
      </G>
      <Path
